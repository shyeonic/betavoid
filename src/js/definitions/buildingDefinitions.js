...
const buildingSize = (size) => ({
  size,
  size_key: `buildingSize.${size}`
});

const buildingCategory = (category) => ({
  category,
  category_key: `buildingCategory.${category}`
});
...
export const BUILDING_DEFINITIONS = {
  ...
  beta_particle_reactor: {
    ...
    ...buildingSize("L"),
    ...buildingCategory("hyperdrive_energy"),
    hp: 1000,
    admin_cost: 15,
  ...
  orbital_defence_turret: {
    ...
    ...buildingSize("S"),
    ...buildingCategory("defense_turret"),
    hp: 1000,
    admin_cost: 2,
    placement_rule: sectorAnchor(640),
    polity_resource: {},
  ...
  hydro_synthesizer: {
    ...
    ...buildingSize("M"),
    ...buildingCategory("resource_production"),
    hp: 1000,
    admin_cost: 2,
